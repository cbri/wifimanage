...
public class CountQuartzDaoImpl implements CountQuartzDao {
	 ...
	 * @return
	 */
	public List queryApId(String districtid) {
		try {
			return sqlMapClient.queryForList("queryApid",districtid);
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return null;
	 ...
	 * @return
	 */
	public Integer queryApOnline(String districtid) {
		try {
			return (Integer) sqlMapClient.queryForObject("queryApOnline",districtid);
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return null;

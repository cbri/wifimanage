...
ActiveRecord::Schema.define(:version => 20140619035039) do
  ...
  create_table "access_nodes_exp", :force => true do |t|
    t.string   "hardware_ver",   :limit => 100
    t.string   "software_ver",   :limit => 100
    t.string   "ssid",           :limit => 50
    t.string   "premodel_ip",    :limit => 40
    t.string   "gwip",           :limit => 40
  ...
  create_table "sys_info", :force => true do |t|
